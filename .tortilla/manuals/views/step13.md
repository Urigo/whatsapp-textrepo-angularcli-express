...
#### [Step 9.1: Optimistic updates](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/commit/eabab9a)
...
#### [Step 9.2: Get chat data from chats cache while waiting for server response](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/commit/0e61d60)
...
#### [Step 9.3: Landing page for new chats/groups](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/commit/9a7ab93)
...
| [< Previous Step](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/tree/master@1.3.0/.tortilla/manuals/views/step12.md) | [Next Step >](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/tree/master@1.3.0/.tortilla/manuals/views/step14.md) |
|:--------------------------------|--------------------------------:|
