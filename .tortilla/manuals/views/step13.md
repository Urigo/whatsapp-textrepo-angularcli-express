...
#### [Step 9.1: Optimistic updates](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/commit/26e8f1b)
...
@@ -241,11 +277,33 @@
 ...
 ┊242┊278┊  }
 ┊243┊279┊
-┊244┊   ┊  addChat(recipientId: string) {
+┊   ┊280┊  addChat(recipientId: string, users: GetUsers.Users[]) {
...
+┊   ┊290┊            name: users.find(user => user.id === recipientId).name,
+┊   ┊291┊            picture: users.find(user => user.id === recipientId).picture,
+┊   ┊292┊            allTimeMembers: [
+┊   ┊293┊              {
...
+┊   ┊345┊            userIds: [currentUserId, recipientIds],
+┊   ┊346┊            allTimeMembers: [
+┊   ┊347┊              {
+┊   ┊348┊                id: currentUserId,
+┊   ┊349┊                __typename: 'User',
+┊   ┊350┊              },
+┊   ┊351┊              ...recipientIds.map(id => ({id, __typename: 'User'})),
+┊   ┊352┊            ],
...
```diff
@@ -5282,6 +5282,11 @@
 ┊5282┊5282┊  dependencies:
 ┊5283┊5283┊    minimist "0.0.8"
 ┊5284┊5284┊
+┊    ┊5285┊moment@^2.23.0:
+┊    ┊5286┊  version "2.23.0"
+┊    ┊5287┊  resolved "https://registry.yarnpkg.com/moment/-/moment-2.23.0.tgz#759ea491ac97d54bac5ad776996e2a58cc1bc225"
+┊    ┊5288┊  integrity sha512-3IE39bHVqFbWWaPOMHZF98Q9c3LDKGTmypMiTM2QygGXXElkFWIH7GxfmlwmY2vwa+wmNsoYZmG2iusf1ZjJoA==
+┊    ┊5289┊
 ┊5285┊5290┊move-concurrently@^1.0.1:
 ┊5286┊5291┊  version "1.0.1"
 ┊5287┊5292┊  resolved "https://registry.yarnpkg.com/move-concurrently/-/move-concurrently-1.0.1.tgz#be2c005fda32e0b29af1f05d7c4b33214c701f92"
```
...
#### [Step 9.2: Get chat data from chats cache while waiting for server response](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/commit/12e1640)
...
#### [Step 9.3: Landing page for new chats/groups](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/commit/e8a8861)
...
@@ -297,8 +324,8 @@
 ...
 ┊298┊325┊  }
 ┊299┊326┊
-┊300┊   ┊  addChat(recipientId: string, users: GetUsers.Users[]) {
-┊301┊   ┊    return this.addChatGQL.mutate(
+┊   ┊327┊  addChat(recipientId: string, users: GetUsers.Users[], ouiId: string) {
...
+┊   ┊336┊            id: ouiId,
 ┊310┊337┊            name: users.find(user => user.id === recipientId).name,
 ┊311┊338┊            picture: users.find(user => user.id === recipientId).picture,
...
+┊   ┊377┊    return this.addChat$;
 ┊350┊378┊  }
 ┊351┊379┊
-┊352┊   ┊  addGroup(recipientIds: string[], groupName: string) {
-┊353┊   ┊    return this.addGroupGQL.mutate(
+┊   ┊380┊  addGroup(recipientIds: string[], groupName: string, ouiId: string) {
+┊   ┊381┊    this.addChat$ = this.addGroupGQL.mutate(
 ┊354┊382┊      {
 ┊355┊383┊        recipientIds,
 ┊356┊384┊        groupName,
```
```diff
@@ -359,7 +387,7 @@
...
+┊   ┊390┊            id: ouiId,
 ...
 ┊365┊393┊            userIds: [currentUserId, recipientIds],
```
```diff
@@ -397,6 +425,7 @@
 ┊397┊425┊          });
...
@@ -17,12 +17,14 @@
 ┊17┊17┊
 ┊18┊18┊  export type Mutation = {
 ┊19┊19┊    __typename?: "Mutation";
-┊20┊  ┊    addChat?: AddChat | null;
+┊  ┊20┊
+┊  ┊21┊    addChat: Maybe<AddChat>;
 ┊21┊22┊  };
 ┊22┊23┊
 ┊23┊24┊  export type AddChat = {
 ┊24┊25┊    __typename?: "Chat";
-┊25┊  ┊    messages: (Messages | null)[];
+┊  ┊26┊
+┊  ┊27┊    messages: (Maybe<Messages>)[];
 ┊26┊28┊  } & ChatWithoutMessages.Fragment;
 ┊27┊29┊
 ┊28┊30┊  export type Messages = Message.Fragment;
```
```diff
@@ -36,12 +38,14 @@
 ┊36┊38┊
 ┊37┊39┊  export type Mutation = {
 ┊38┊40┊    __typename?: "Mutation";
-┊39┊  ┊    addGroup?: AddGroup | null;
+┊  ┊41┊
+┊  ┊42┊    addGroup: Maybe<AddGroup>;
 ┊40┊43┊  };
 ┊41┊44┊
 ┊42┊45┊  export type AddGroup = {
 ┊43┊46┊    __typename?: "Chat";
-┊44┊  ┊    messages: (Messages | null)[];
+┊  ┊47┊
+┊  ┊48┊    messages: (Maybe<Messages>)[];
 ┊45┊49┊  } & ChatWithoutMessages.Fragment;
 ┊46┊50┊
 ┊47┊51┊  export type Messages = Message.Fragment;
```
```diff
@@ -107,14 +111,18 @@
 ┊107┊111┊
 ┊108┊112┊  export type Query = {
 ┊109┊113┊    __typename?: "Query";
-┊110┊   ┊    users?: Users[] | null;
+┊   ┊114┊
+┊   ┊115┊    users: Maybe<Users[]>;
 ┊111┊116┊  };
 ┊112┊117┊
 ┊113┊118┊  export type Users = {
 ┊114┊119┊    __typename?: "User";
+┊   ┊120┊
 ┊115┊121┊    id: string;
-┊116┊   ┊    name?: string | null;
-┊117┊   ┊    picture?: string | null;
+┊   ┊122┊
+┊   ┊123┊    name: Maybe<string>;
+┊   ┊124┊
+┊   ┊125┊    picture: Maybe<string>;
 ┊118┊126┊  };
 ┊119┊127┊}
```
...
| [< Previous Step](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/tree/master@1.4.0/.tortilla/manuals/views/step12.md) | [Next Step >](https://github.com/Urigo/whatsapp-textrepo-angularcli-express/tree/master@1.4.0/.tortilla/manuals/views/step14.md) |
|:--------------------------------|--------------------------------:|
